...
import { useRegisterSubmit } from "../hooks/handleSubmit";
...
export default function FormRegister() {
    ...
    return (
        <form action={handleSubmit} className="p-4 w-full">
            <h1 className="font-bold text-center text-slate-700 text-3xl">Register</h1>
            <div className="flex flex-col mt-4 text-gray-600 gap-8">
                <div className="w-full max-w-sm min-w-[200px]">
                    <label htmlFor="" className="text-slate-400">Name</label>
                    <input
                        name="name"
                        type="text"
