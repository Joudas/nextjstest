'use client'
import { HandleGoogleSignIn } from "@/features/login/hooks/handleGoogleSignIn";
import { HandleGitHubSignIn } from "@/features/login/hooks/handleGitHubSignIn";


export default function ButtonsSignIn() {
    return (
        <>
            <button
                onClick={HandleGoogleSignIn}
                type="button"
                className="flex items-center gap-1 bg-white text-medium text-base text-slate-700 h-10 w-full border-slate-200 rounded-md px-3 py-2 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 cursor-pointer shadow-sm hover:shadow-lg">
                <span>
